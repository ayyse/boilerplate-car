...
{
    public abstract class MyFirstProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyFirstProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyFirstProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyFirstProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyFirstProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyFirstProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyFirstProjectDbContext, Task<T>> func)
        {
            T result;
